...
router.get('/team',homeController.team); //redirected to controller rendering doctors page
router.post('/submit-mail', homeController.submit_contact); //redirected to controller rendering contact page
